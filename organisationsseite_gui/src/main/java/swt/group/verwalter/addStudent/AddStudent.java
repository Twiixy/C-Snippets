 ...
 */
package swt.group.verwalter.addStudent;
...
public class AddStudent extends WebPage {
    //PersonRepository pr = new PersonRepository();
	private static final long serialVersionUID = 1L;

	public AddStudent(final PageParameters parameters) {
		super(parameters);
        ...
        Button speicherbtn = new Button("speicherbtn"){
            ...
            public void onSubmit() {
                ...
                PersonData a = new PersonData("1",TAVorname.getModelObject().toString(),TANachname.getModelObject().toString()
                        ,TABetrieb.getModelObject().toString(),TaEmail.getModelObject().toString(),"2",TAPasswort.getModelObject().toString());
                
                PersonRepository.addPerson(a);
                 info("Student hinzugefügt");
